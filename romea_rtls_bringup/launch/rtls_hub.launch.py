        ...
        PythonLaunchDescriptionSource(
            [
                PathJoinSubstitution(
                    [
                        FindPackageShare("romea_rtls_transceivers_bringup"),
                        "launch",
                        "rtls_transceivers_drivers.launch.py",
                    ]
                )
            ]
        ),
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument("remote_transceivers_meta_description_file_paths")
    )

    declared_arguments.append(
        DeclareLaunchArgument("connected_transceivers_meta_description_file_paths")
    )
    ...
    declared_arguments.append(
        DeclareLaunchArgument("rtls_namespace", default_value="")
    )
